...
IMG_H, IMG_W   = 256, 512          # EfficientNet-B0 input — full spectrogram
#
# Preprocessing matches train_and_export.py get_transforms() exactly:
#   Resize(256, 512) → ToTensor() [/255.0]
#   NO ImageNet mean/std normalisation
# IMAGENET_MEAN/STD defined below for save_spectrogram_png() visualisation only.
